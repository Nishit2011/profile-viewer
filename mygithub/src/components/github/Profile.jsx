//the area that will have profile image,link etc
...
<div className="panel panel-default">
  ...
  <div className="panel-body">
    <div className="row">
     <div className="col-md-4"><img src={this.props.userData.avatar_url} className="thumbnail"  style={{width:"100%"}} /></div>
     ...
     <li className="list-group-item"><strong>Email Id:</strong>{this.props.userData.email}</li>
     </ul>
     </div>
     </div>
